...
corr=(np.corrcoef(ret,ret_indx_list))
...
beta= (sd_ret/sd_indx)*Rsq

# Finding Alpha
risk_free_rate=0.0647
alpha = (mean-risk_free_rate)-beta*(mean_indx-risk_free_rate)


print ("Mutual Fund risk Alpha:%2.5f,beta:%2.2f,R square: %2.1f percent." % (alpha,beta,Rsq*100))
